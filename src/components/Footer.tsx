    ...
    <footer className="bg-brand-darkest pt-24 pb-12 text-brand-gray">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-16 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li>
                <a href="/" className="hover:text-brand-mint transition-colors">
                  Accueil
                </a>
              </li>
              <li>
                <a href="/#philosophie" className="hover:text-brand-mint transition-colors">
                  {t('nav.philosophy')}
                </a>
              </li>
              <li>
                <a href="/#methode" className="hover:text-brand-mint transition-colors">
                  {t('nav.method')}
                </a>
              </li>
              <li>
                <a href="/#talents" className="hover:text-brand-mint transition-colors">
                  {t('nav.talents')}
                </a>
              </li>
              <li>
                <a href="/#resultats" className="hover:text-brand-mint transition-colors">
                  Résultats
                </a>
              </li>
              <li>
                <a href="/#offres" className="hover:text-brand-mint transition-colors">
                  {t('nav.offers')}
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-6 pt-4">
                <a
                  href="https://www.linkedin.com/feed/update/urn:li:activity:7445384694113689601/?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFtWAb0BeX-QzMxkKcRirD6y5gtRAWI9vic"
                ...
                <a
                  href="https://www.instagram.com/lucid_agence?igsh=aTZtdjlleGdpN2ho&utm_source=qr"
                  className="hover:text-brand-mint transition-colors"
                  title="Instagram"
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-xs">© 2026 LUCID Agency. Tous droits réservés.</p>
          <div className="flex gap-8">
            <a href="#" className="text-xs hover:text-brand-mint transition-colors">
